...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/host/web-auth': { kind: 'none', reason: 'The authentication seam decides who may reach the carrier and registers nothing model-facing.' },
  'packages/host/web-auth-password': { kind: 'none', reason: 'The password provider verifies a submitted secret for the authentication seam and registers nothing model-facing.' },
  'packages/host/web-auth-cloudflare-access': { kind: 'none', reason: 'The Cloudflare Access provider verifies a forwarded token for the authentication seam and registers nothing model-facing.' },
