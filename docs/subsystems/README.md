...
| [web-auth.md](web-auth.md) | the web-access authentication seam: `WebAuthProvider`'s two verification surfaces, `WebAuthIdentity`, sign-in sessions and cookie attributes, and how the carrier layers the requirement onto its authority fence |
